        ...
        <main className="flex min-h-screen flex-col p-5 md:p-28 gap-4">
            ...
            <div className="w-full mb-5 items-center">
                ...
                {fetchedParticipant && !editMode && (
                    <div className="mt-5">
                        <Label>
                            Name: {fetchedParticipant["Participant"].name}
                        </Label>
                        <br></br>
                        <Label>
                            Email: {fetchedParticipant["Participant"].email}
                        </Label>
                        <br></br>
                        <Label>
                            Phone: {fetchedParticipant["Participant"].phone}
                        </Label>
                        <br></br>
                        <Label>
                            College: {fetchedParticipant["Participant"].college}
                        </Label>
                        {fetchedParticipant["Participant"].pesHostel.length >
                            0 && (
                            <Label>
                                {fetchedParticipant["Participant"].pesHostel}
                            </Label>
                        )}
                        {fetchedParticipant["Participant"].pesHostel.length ==
                            0 && <p>Not part of pes hostel</p>}
                    </div>
                )}
                ...
                {fetchedParticipant && editMode && (
                    <form className="mt-5 space-y-3">
                        <div>
                            ...
                            <Input
                                placeholder="Name"
                                value={fetchedParticipant["Participant"].name}
                                onChange={(e) =>
                                    setFetchedParticipant({
                                        ...fetchedParticipant,
                                        Participant: {
                                            ...fetchedParticipant[
                                                "Participant"
                        ...
                        <div>
                            ...
                            <Input
                                placeholder="Email"
                                value={fetchedParticipant["Participant"].email}
                                onChange={(e) =>
                                    setFetchedParticipant({
                                        ...fetchedParticipant,
                                        Participant: {
                        ...
                        <div>
                            ...
                            <Input
                                ...
                                value={fetchedParticipant["Participant"].phone}
                                onChange={(e) =>
                                    setFetchedParticipant({
                                        ...fetchedParticipant,
                                        Participant: {
                        ...
                        <div>
                            ...
                            <Input
                                placeholder="College"
                                value={
                                    fetchedParticipant["Participant"].college
                                }
                                onChange={(e) =>
                                    setFetchedParticipant({
                                        ...fetchedParticipant,
