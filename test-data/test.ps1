...
$sourceFile = "C:\Users\Adhesh\Desktop\projects\eventloop\event-loop-backend\test-data\qr-png\anirudh.sudhir1@gmail.com-NAME_ABC-b72fad1b-7832-56dc-9327-ab1f3f03c18e.png"
...
for ($i = 1; $i -le 200; $i++) {
    ...
    $newFileName = "anirudh.sudhir1@gmail.com-NAME_ABC-b72fad1b-7832-56dc-9327-ab1f3f03c18e($i).png"
